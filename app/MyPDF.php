...
function Header()
{
	...
	$this->Cell(280,0,strtoupper($title),0,0,'C');
	$this->Ln(7);
	$this->SetFont('Arial','B',13);
	
	$this->Cell(280,0,strtoupper($address),0,0,'C');
	$this->Ln(7);
	
	$this->Cell(280,0,strtoupper($email),0,0,'C');
	$this->Ln(7);

	$this->Cell(280,0,strtoupper($phone),0,0,'C');
    // Line break
    $this->Ln(9);
}
