        ...
        <div class="page-content-wrapper ">
            ...
            <div class="container-fluid">  
                    ...
                    <div class="col-sm-12">
                        <div class="page-title-box">
                            <div class="row align-items-center">
                                <div class="col-md-6">
                                    <h4 class="page-title m-0">CREATE NEW INVOICES</h4>
                                </div>
                                <div class="col-md-6">
                                  
                                    
                                  
                                    <a href="{{URL::to('/')}}/invoices" class="btn btn-info btn-md float-right mr-1"   role="button"><b class="fa fa-undo"> Back to Invoices </b></a>
                ...
                <div class="row">
                 ...
                 <form class="form-horizontal" method="post" action="invoice/store" enctype="multipart/form-data" >
                  {{ csrf_field() }}
                <div class="card-body">
                  ...
                  <div class="form-group row">
                    <label for="budget" class="col-sm-2 col-form-label">Invoice Date</label>
                    <div class="col-sm-10">
                ...
                <div class="form-group row">
                  <label for="budget" class="col-sm-2 col-form-label">Due Date</label>
                  <div class="col-sm-10">
                    <div class="input-group">
                      <input type="text" class="form-control" autocomplete="off" id="datepicker-deadline" name="due_date" >
                      <div class="input-group-append bg-custom b-0"><span class="input-group-text"><i class="mdi mdi-calendar"></i></span></div>
                  </div><!-- input-group -->
                  </div>
              </div>
