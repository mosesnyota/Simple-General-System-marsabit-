        ...
        <div class="col-sm-12">
            ...
            <div class="col-xl-8 col-md-9">
               <div class="card bg-primary mini-stat text-white">
                  <div class="p-4 mini-stat-desc">
                    <div class="clearfix">
                        <h6 class="text-uppercase mt-0 float-left text-white-50"> {{$invoice ->narration}}</h6>
        ...
        <div class="col-xl-12">
            <div class="card">
                ...
                <div class="card-footer">
                    ...
                    <button type="button"  id="bt" value="Save Invoice" onclick="submitData(<?php echo $invoice->invoice_id  ?>)" class="btn btn-secondary">Save Invoice</button>
                    </div>
                 </div>
            </div>
        </div>
...
<script>
 ...
 $.ajaxSetup({
  ...
  $.ajax({
      url: "{{ url('savequotation')}}",
      method: 'post',
      data: JSON.stringify(arrValues),
      success: function(response){
        var invoiceID = response;
        //console.log( invoiceID);
        window.location.href = "../quotations/"+invoiceID+"/open";
      }});
