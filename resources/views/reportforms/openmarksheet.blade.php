                    ...
                    <div class="col-sm-12">
                        <div class="page-title-box">
                            <div class="row align-items-center">
                                <div class="col-md-6">
                                    <h4 class="page-title m-0">PRINT MARKS SHEET REPORT</h4>
                                </div>
                ...
                <div class="row">
                 ...
                 <div class="card-body p-0">
                    <form role="form" method="post" action="reportforms/print" enctype="multipart/form-data" >
                        ...
                        <a class="btn btn-warning btn-lg" href="markssheet/{{$inputs['course_id']}}/{{$inputs['examyear']}}/{{$inputs['term']}}/{{$inputs['examtype']}}/print"  target="_blank"><i class="fa fa-print">DOWNLOAD PDF REPORT</i></a>
