                            ...
                            <div class="row align-items-center">
                                <div class="col-md-6">
                                    <h4 class="page-title m-0"><button type="button" class="btn btn-secondary btn-md  mr-1"
                                        > <b >  <h3><b> {{" Subjects   :   ".$subjects->count()}} </b></h3>
                                        </b></button> </h4>
                                </div>
                                <div class="col-md-6">
                                    <button type="button" class="btn btn-success btn-lg float-right mr-1"
                                        ...
                                        data-keyboard="false" href="#"> <b class="fa fa-plus-circle"> ADD SUBJECT
                                        </b></button>
                                        ...
                                        <?php $counter = 1; ?>
                                            @foreach ($subjects as $subject)
                                                <tr>
                                                    ...
                                                    <td>
                                                                <a class="btn btn-primary btn-sm" href="subjects/{{$subject->subject_id}}/edit"><i class="fas fa-edit"></i></a>
                                                                <button type="button" class="btn btn-danger btn-sm mr-1 delete-confirm"  href="subjects/{{$subject->subject_id}}/destroy"> <a  data-role="deletepetty"> <i class="fa fa-trash" > </i></a>  </button>  
